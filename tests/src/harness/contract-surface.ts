 ...
 * 2026-08-07T00:00:00Z — same anchor as `GENESIS_BLOCK_TIME` / contracts harness.
 */
export const NOW = 1_786_147_200;
export const EPOCH = BigInt(NOW) / EPOCH_DURATION;
export const EPOCH_NEXT = EPOCH + 1n;
export const NEXT_TIME = Number(EPOCH_NEXT * EPOCH_DURATION);
